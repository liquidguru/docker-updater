...
- **Image size on the card** — each container card shows its image's on-disk size; when an update is available, a **↓** chip also shows the compressed download size of the new image from the registry manifest
