...
- **"Reclaim disk space now" button** (Settings) — a one-click, dangling-images-only prune. Superseded in 1.13.0 by the selectable list, which shows what's being removed instead of running blind
